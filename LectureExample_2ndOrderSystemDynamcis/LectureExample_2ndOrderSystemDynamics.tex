...
\begin{frame}
	...
	\begin{itemize}[<+->]
		...
		\]
		\only<+| handout:0>{\begin{center}\includegraphics[width = 0.3\textwidth]{Images/step_response_1st.jpg}\end{center}}
	...
	\only<+->{\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\centering
			\only<.(-2)| handout:0>{\includegraphics[width=0.5\columnwidth]{Images/step_response_2nd_overdamped.png}}
			\only<.(-1)| handout:0>{\includegraphics[width=0.5\columnwidth]{Images/step_response_2nd_critdamped.png}}
			\only<.| handout:0>{\includegraphics[width=0.5\columnwidth]{Images/step_response_2nd_underdamped.png}}
			\only<+->{\includegraphics[width=\columnwidth]{Images/step_response_2nd.png}}
		\end{column}
	\end{columns}}
\end{frame}
